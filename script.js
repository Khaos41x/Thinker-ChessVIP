...
(function () {
  ...
  function createMenu() {
    ...
    const bannerHtml = `
      ...
      <div id="thinker-chess-banner" style="position: absolute; right: -9999px; top: 100px; z-index: 999999; display: flex; transition: all 0.3s ease; background-color: #ffffff;">
