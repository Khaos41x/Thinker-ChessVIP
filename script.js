  ...
  function createMenu() {
    ...
    const checkExist = setInterval(function () {
      ...
      if (mainDiv.length) {
        ...
        // Dynamically position the banner next to the sidebar
        setInterval(() => {
          ...
          if (sidebar && banner) {
            ...
            if (availableSpace > 160) { 
                ...
                banner.style.width = Math.min(280, availableSpace - 30) + 'px';
