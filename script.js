...
(function () {
  ...
  function createMenu() {
    ...
    const menuHtml = `
      ...
      <div id="thinker-chess-banner" style="position: fixed; right: 15px; top: 100px; width: 280px; text-align: center; z-index: 999999; display: flex; flex-direction: column; align-items: center; gap: 18px;">
